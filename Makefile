...
INCLUDE1.5=$(PWD)/doublefsr/include
INCLUDE2=$(shell dirname $(PWD))/include
FF=$(F77) $(FFLAGS) $(FPE) $(OPT) $(DEBUG) -I$(INCLUDE0) -I$(INCLUDE1) -I$(INCLUDE1.5) -I$(INCLUDE2)
...
PWHGANAL+= fastjetCDFMidPointwrap.o fastjetD0RunIIConewrap.o
else
...
PYTHIA=main-PYTHIA.o setup-PYTHIA-lhef.o pythia.o boostrot.o	\
	powheginput.o pwhg_bookhist.o $(PWHGANAL) lhefread.o newunit.o	\
